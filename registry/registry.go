...
// ServerItem is information related to a server
...
// Heartbeat send a heartbeat message every once in a while (duration)
...
func sendHeartbeat(registry, addr string) error {
	...
	req, _ := http.NewRequest("POST", registry, nil) // update s.start here
